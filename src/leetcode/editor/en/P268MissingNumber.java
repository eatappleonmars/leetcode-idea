...
// Related Topics Array Hash Table Math Bit Manipulation Sorting 👍 6178 👎 2885
//
...
//            return solveUsingMath(nums);
            return solveWithBits(nums);
        }

        // Time: O(n)
        // Space: O(1)
        // Hint: n ^ n = 0
        private int solveWithBits(int[] nums) {
        ...
        private int solveUsingMath(int[] nums) {
            int sum = 0;
            for (int n : nums) {
                sum += n;
            }
