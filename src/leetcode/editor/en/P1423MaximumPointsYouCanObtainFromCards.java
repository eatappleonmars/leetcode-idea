...
// Related Topics Array Sliding Window Prefix Sum 👍 2373 👎 96
...
public class P1423MaximumPointsYouCanObtainFromCards {
    ...
    class Solution {
        public int maxScore(int[] cardPoints, int k) {
            ...
            for (int lt = k - 1, rt = len - 1; lt >= 0; lt--, rt--) {
                sum = sum - cardPoints[lt] + cardPoints[rt];
    ...
    public static void main(String[] args) {
        Solution sol = new P1423MaximumPointsYouCanObtainFromCards().new Solution();
