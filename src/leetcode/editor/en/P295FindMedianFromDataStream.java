...
public class P295FindMedianFromDataStream {
    ...
    class MedianFinder {
        ...
        private Queue<Integer> firstHalf; // max heap
        private Queue<Integer> secondHalf; // min heap

        public MedianFinder() {
            this.firstHalf = new PriorityQueue<>(Comparator.reverseOrder());
        ...
        public void addNum(int num) {
            ...
            // Balance two heaps by keeping 0 <= firstHalf.size() - secondHalf.size() <= 1
