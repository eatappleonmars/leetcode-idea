...
// 
// Related Topics String Union Find 👍 182 👎 10
    ...
    class Solution {
        public String smallestEquivalentString(String s1, String s2, String baseStr) {
            ...
            for (int i = 0; i < s1.length(); i++) {
                int c1 = findRoot(parents, s1.charAt(i) - 'a');
                int c2 = findRoot(parents, s2.charAt(i) - 'a');
            ...
            char[] baseStrCharArray = baseStr.toCharArray();
            for (int i = 0; i < baseStrCharArray.length; i++) {
                baseStrCharArray[i] = (char) (findRoot(parents, baseStrCharArray[i] - 'a') + 'a');
            }

            return new String(baseStrCharArray);
        }
...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public static void main(String[] args) {
        Solution sol = new P1061LexicographicallySmallestEquivalentString().new Solution();
