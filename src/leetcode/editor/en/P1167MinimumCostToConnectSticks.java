...
//are given as an array sticks, where sticks[i] is the length of the iᵗʰ stick. 
//
...
// 1 <= sticks[i] <= 10⁴ 
// 
// Related Topics Array Greedy Heap (Priority Queue) 👍 1029 👎 149
...
public class P1167MinimumCostToConnectSticks {
    ...
    public static void main(String[] args) {
        Solution sol = new P1167MinimumCostToConnectSticks().new Solution();
