...
// 
//
// Related Topics String Stack 👍 2982 👎 585
...
public class P71SimplifyPath {
    ...
    class Solution {
        public String simplifyPath(String path) {
            return solveWith2Pointers(path);
            // TODO: return solveWithStack(path);
        }

        private String solveWith2Pointers(String path) {
    ...
    public static void main(String[] args) {
        Solution sol = new P71SimplifyPath().new Solution();
        String[] test = "/a//b/c/e".split("/");
