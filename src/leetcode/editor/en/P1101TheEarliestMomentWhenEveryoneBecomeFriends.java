...
// 
// Related Topics Array Union Find 👍 477 👎 12
...
public class P1101TheEarliestMomentWhenEveryoneBecomeFriends {
    ...
    class Solution {
        public int earliestAcq(int[][] logs, int n) {
            ...
            for (int[] log : logs) {
                int aRoot = findRoot(parents, log[1]);
                int bRoot = findRoot(parents, log[2]);
    ...
    public static void main(String[] args) {
        Solution sol = new P1101TheEarliestMomentWhenEveryoneBecomeFriends().new Solution();
